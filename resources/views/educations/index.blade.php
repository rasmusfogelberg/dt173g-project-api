                    ...
                    <tbody class="bg-white">
                      @foreach($educations as $education)
                        <tr>
                          ...
                          <td class="px-6 py-4">
                            {{$education->ended_at ?? 'Ongoing'}}
                          </td>
                          <td colspan="2" class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex flex-row">
                              <a href="{{ route('educations.edit', $education) }}" class="text-indigo-600 hover:text-indigo-900">
                                Edit
                              ...
                              <form action="{{ route('educations.destroy', $education) }}" method="POST" class="ml-2">
                                @method('DELETE')
                                @csrf
